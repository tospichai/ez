...
@section('title', 'Field 4 (Works Type-Structure)')
...
@section('content')
    <form action="{{ route('import.work') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="shadow-lg bg-white rounded-lg">
            <div class="px-8 py-8 mb-0">
                <div class="text-4xl">Field 4 (Works Type-Structure)</div>
            </div>
            <div class="p-8 py-0">
